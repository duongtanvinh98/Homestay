...
<hr>
<c:url value="/addNewPhong" var="addNewPhong" />
<mvc:form modelAttribute="phong" class="form-horizontal" action="${addNewPhong}">
    <div class="form-group">
         <mvc:hidden path="homestayOwners.id" value= "${homestayOwnerById.id}" />
        <label class="control-label col-sm-2" >Mã phòng</label>
        <div class="col-sm-3">
            <mvc:input path="maPhong" required="true" placeholder="Mã phòng" class="form-control" />
        </div>      
        <label class="control-label col-sm-2" >Loại phòng</label>
        <div class="col-sm-3">
            <mvc:input path="lPhong" required="true" placeholder="Loại phòng" class="form-control" />
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-2" >Diện tích</label>
        <div class="col-sm-3">
            <mvc:input path="dTich" required="true" placeholder="Diện tích" class="form-control" />
        </div>      
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <mvc:input path="diaDiem" required="true" placeholder="Địa điểm" class="form-control" />
        </div>    
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <mvc:input path="thongTinPhong.slNguoiO" required="true" placeholder="Số lượng người ở" class="form-control" />
        </div>       
